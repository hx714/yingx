   ...
   <script>
        $(function () {
           $("#loginForm").submit(function () {
              $.post("${path}/admin/login",$("#loginForm").serialize(),function (res) {
                  if(res.success==true){
                      alert(res.msg+"点击确定跳转至首页！");
                      location.href="${path}/main/main.jsp";
                  }else{
                      $("#msgDiv").html("<h5 style='color: red'>"+res.msg+"</h5>")
                  }
              },"JSON");
               return false;//阻止表单提交
           });
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/cover">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="clientCode" id="form-code">
                            </div>
